...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 flex items-center justify-center px-4">
      <div className="w-full max-w-4xl mx-auto p-6 bg-white dark:bg-gray-900 rounded-lg shadow-xl mt-8">
          ...
          <div className="flex-shrink-0 w-full md:w-1/3 flex flex-col items-center justify-start text-center">
            <div className="w-40 h-40 rounded-full overflow-hidden border-4 border-primary shadow-lg relative group">
              {avatarUrl ? (
                ...
                <div className="w-full h-full flex items-center justify-center bg-gray-200 dark:bg-gray-700 text-gray-400 dark:text-gray-500 text-6xl font-bold">
            ...
            <div className="mt-6 w-full">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">@{username || 'unnamed'}</p>
            </div>
          </div>

          <div className="flex-grow">
            <h2 className="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-100">Profile Settings</h2>
